...
class LeverancierController extends Controller
{
    ...
    public function update(Request $request, $id)
    {
        ...
        // Show error if the mobile number (mobiel) is the same as before, regardless of other fields
        $current = $this->model->sp_GetLeverancierDetails($leverancierId);
        if ($current && $current->Mobiel === $validated['mobiel']) {
